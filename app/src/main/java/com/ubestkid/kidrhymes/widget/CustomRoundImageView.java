...
public class CustomRoundImageView extends AppCompatImageView {
    ...
    public CustomRoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        type = array.getInt(R.styleable.CustomRoundImageView_type, TYPE_ROUND);
        scaleType = array.getInt(R.styleable.CustomRoundImageView_scale, SCALE_TYPE_FIT);

        corners_top_left = array.getBoolean(R.styleable.CustomRoundImageView_top_left, true);
        corners_top_right = array.getBoolean(R.styleable.CustomRoundImageView_top_right, true);
        corners_bottom_left = array.getBoolean(R.styleable.CustomRoundImageView_bottom_left, true);
        corners_bottom_right = array.getBoolean(R.styleable.CustomRoundImageView_bottom_right, true);

        borderRadius = array.getDimensionPixelSize(R.styleable.CustomRoundImageView_borderRadius, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, BODER_RADIUS_DEFAULT, getResources().getDisplayMetrics()));
        array.recycle();
    }
